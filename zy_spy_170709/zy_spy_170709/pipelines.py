...
class MysqlPipeline(object):
	...
	def process_item(self, item, spider):
		...
		args = (item["com_id"], item["com_name"], item["heat"], item["short_intro"], item["nature_size"], item["industry"], item["short_name"], item["intro"], item["location"], item["com_url"], item["job_num"], item["jobs"], item["city"], item["com_tab"])
